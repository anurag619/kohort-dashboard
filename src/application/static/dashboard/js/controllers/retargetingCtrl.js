...
appLungeControllers.controller('retargetingCtrl', ['$scope', '$rootScope', '$state', '$stateParams','dummydata','Querydata','retarget_audience','reverse_value','edited_rules','email_retargeting','ids_retargeting' ,'Viewpost', function (a, rootScope, state, stateParams,dummydata,Querydata, all_audience,reverse_value,edited_rules,email_retargeting,ids_retargeting,Viewpost) {
		...
		a.audience_list = all_audience.response.data;
		//a.audience_list = []
		...
		a.tempAudience = function(val){
			...
			if(val){
				...
				Viewpost.query({appid:rootScope.app_id, filter: a.temp_audience}, 'retarget_audience').then(function(data){

					console.log(data)

					if(data.response.status=="success"){
		
			 			state.go("app.appId.option.retargeting", 
